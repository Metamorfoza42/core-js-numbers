...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const cosAngle = scalarProduct / (length1 * length2);
...
function toNumber(value, def) {
  const convertTry = Number(value);
  return Number.isNaN(convertTry) ? def : convertTry;
}
